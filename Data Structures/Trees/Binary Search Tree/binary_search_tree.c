...
{
    struct binary_search_tree_t *new_tree = (struct binary_search_tree_t*)malloc(sizeof(struct binary_search_tree_t));
...
void bst_display(struct node_t *node)
{
